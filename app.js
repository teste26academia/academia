...
function renderPresences() {
  ...
  document.querySelectorAll("[data-delete]").forEach((btn) => {
    btn.addEventListener("click", async () => {
      const ok = confirm("Excluir aluno? O cadastro será removido.");
      if (!ok) return;
