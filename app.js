...
function bindButtons() {
  ...
  document.getElementById("mobileAlunoBtn")?.addEventListener("click", () => { if (!state.currentUser) return alert("Faça login primeiro."); show("aluno"); });
  document.getElementById("mobileCardBtn")?.addEventListener("click", () => { if (!state.currentUser) return alert("Faça login primeiro."); show("card"); });
