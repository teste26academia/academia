...
const scheduleOptions = [
  { id: "seg-1500", label: "Segunda - 15:00 às 16:00" },
  { id: "seg-1630", label: "Segunda - 16:30 às 17:30" },
  { id: "seg-1800", label: "Segunda - 18:00 às 19:00" },
  { id: "ter-1000", label: "Terça - 10:00 às 11:00" },
  { id: "ter-2030", label: "Terça - 20:30 às 21:30" },
  { id: "qua-1500", label: "Quarta - 15:00 às 16:00" },
  { id: "qua-1630", label: "Quarta - 16:30 às 17:30" },
  { id: "qua-1800", label: "Quarta - Tai Chi 18:00 às 19:00" },
  { id: "qua-1930", label: "Quarta - 19:30 às 20:30" },
  { id: "qua-2100", label: "Quarta - Boxe Chinês 21:00 às 22:00" },
  { id: "qui-1000", label: "Quinta - 10:00 às 11:00" },
  { id: "qui-2030", label: "Quinta - 20:30 às 21:30" },
  { id: "sex-1500", label: "Sexta - 15:00 às 16:00" },
  { id: "sex-1630", label: "Sexta - 16:30 às 17:30" },
  { id: "sex-1800", label: "Sexta - Tai Chi 18:00 às 19:00" },
  { id: "sex-1930", label: "Sexta - 19:30 às 20:30" },
  { id: "sex-2100", label: "Sexta - Boxe Chinês 21:00 às 22:00" },
  { id: "sab-1115", label: "Sábado - 11:15 às 12:15" }
];
...
function renderScheduleOptions() {
  el.presenceAula.innerHTML = "";
  scheduleOptions.forEach((s) => {
    const opt = document.createElement("option");
    opt.value = s.label;
    opt.textContent = s.label;
    el.presenceAula.appendChild(opt);
  });
}
...
function renderPresences() {
  ...
  state.presences.slice(0, 10).forEach((p) => {
    ...
    card.innerHTML = `<div class="font-semibold text-emerald-400">${escapeHtml(aluno?.nome || "Aluno removido")}</div><div class="text-zinc-300">Aula: ${escapeHtml(p.aula || "-")}</div><div class="text-zinc-300">Data: ${escapeHtml(p.data || "-")}</div><div class="text-zinc-300">Horário: ${escapeHtml(p.hora || "-")}</div>`;
...
function bindButtons() {
  ...
  document.getElementById("btnLogout").addEventListener("click", async () => { localStorage.removeItem("adminUnlocked"); await signOut(auth); state.role = "guest"; });
