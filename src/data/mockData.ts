...
export const INITIAL_CONFIG: GlobalConfigs = {
  ...
  avisoMural: "Bem-vindos à Academia Garra de Águia Praia Grande! Foco nos treinos de Kung Fu, Tai Chi Chuan e Boxe Chinês. Exames de faixa aproximando-se!",
...
export const INITIAL_TURMAS: Turma[] = [
  {
    ...
    instrutorId: "ins_1",
    instrutorNome: "Sifu Décio Padovani",
...
export const MOCK_USERS: UserProfile[] = [
  { uid: "user_admin", nome: "Sifu Décio Padovani (Diretor/Admin)", email: "deciopadovanijr@gmail.com", role: UserRole.ADMIN },
  ...
  { uid: "user_student_k", nome: "Sifu Décio (Aluno Preview)", email: "deciopadovanijr@gmail.com", role: UserRole.ALUNO, alunoId: "stu_1" },
