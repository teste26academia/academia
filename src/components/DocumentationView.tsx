        ...
        <section className="border-l-2 border-red-600 pl-4 space-y-4">
          ...
          <div className="bg-slate-950/80 p-4 rounded-lg border border-slate-800 text-sm space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-1 text-slate-300">
              ...
              <li><strong>Gestão Escopo Aluno [CRUD]:</strong> Cadastro, suspensão, histórico de lesões, dados clínicos, termos de responsabilidade civil e histórico marcial.</li>
            ...
            <p className="font-semibold text-red-400 mt-4">2. PAINEL DO INSTRUTOR (Laoshi/Sifu):</p>
            <ul className="list-disc pl-5 space-y-1 text-slate-300">
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-2 border-t border-slate-800 pt-3">
              <div>
                ...
                <ul className="list-disc pl-5 text-xs text-slate-300 space-y-1">
                  ...
                  <li><strong>Mesa Avaliadora:</strong> Input text para Sifu / Mestres examinadores</li>
  ...
  - main.tsx        # Renderização do React no nível do DOM`}
        ...
        <section className="border-l-2 border-red-600 pl-4 space-y-4 text-sm">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-bold text-white uppercase tracking-wider">10 e 11. Auditoria de UX/UI e Funcionalidades do Mundo Marcial</h3>
          </div>
          <div className="bg-slate-950/80 p-4 rounded-lg border border-slate-800 space-y-3">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 text-xs text-slate-300 space-y-1">
                <li><strong>Genealogia SHAOLIN / Linhagem (Lineage Tree):</strong> Visualizador dinâmico de árvore genealógica de mestres que conecta o estudante à raiz chinesa de seu estilo. Mantém as tradições de respeito e respeito marcial (Wu De).</li>
                <li><strong>Controle de Armas e Arsenal (Equipment Tracking):</strong> Gestão de estoque e empréstimo de armas de treino (Bastão/Gun, Espada/Jian, Sabão/Dao, Lança/Qiang) que pertencem ao templo escolar.</li>
                <li><strong>Glossário de Termos em Mandarim / Pinyin:</strong> Biblioteca interativa interna com pronúncia fonética e caracteres chineses para os nomes de golpes físicos, saudações formais (Bai Shi, Kin Lai) e conceitos teóricos para facilitar o estudo de exames na academia.</li>
                <li><strong>Regulamento de Wu De e Conduta Ética:</strong> Termos declarados visíveis de disciplina, filosofia budista ou taoísta e respeito aos pares, essenciais dentro das escolas de artes marciais orientais tradicionais.</li>
              </ul>
            </div>
          </div>
        </section>
