          ...
          <div className="space-y-2 text-xs leading-relaxed text-zinc-300 font-sans">
            {integrity.percent === 100 ? (
              <p className="border-l-2 border-emerald-500 pl-3">
                ...
                Todas as coleções estão perfeitamente sincronizadas, o brasão oficial foi encontrado e os módulos de segurança estão ativos sob zero-trust. O portal marcial está plenamente verificado.
              </p>
